        ...
        if winner["name"] == "star":
            items.append({
                ...
                "text": (
                    ...
                    f"tested, a window short of flow has produced errors in "
                    f"both directions - stars missed, and one linear melt that "
                    f"came back as a star - but it is a warning, not a verdict: "
                    f"on a third set the class was right on two such curves, "
                    f"recovering that paper's own plateau modulus to within 4%. "
                    f"Treat this as evidence you should check, not as a reason "
                    f"to reject the call. "
